			    ...
			    if ($lotes && is_array($lotes)) {
			        ...
			        foreach ($lotes as $lote) {
			            ...
			            foreach ($lote['itens'] as $item) {
			                ...
			                // Obtém o nome da taxonomia corretamente
	    	...
	    	<form method="post" autocomplete="off" action="<?php bloginfo('url');?>/insert-inscricao">
	            <div class="row d-flex">
	                ...
	                <div class="col-md-6 mb-3">
	                    <label class="fw-bold" for="evento">Evento <span class="text-danger">*</span></label>
					        ...
					        <?php if (!empty($modalidades_ativas)): ?>
					            <?php foreach ($modalidades_ativas as $modalidade): ?>
					                <option value="<?php echo esc_attr($modalidade['categoria']); ?>">
					                    <?php echo esc_html($modalidade['categoria']) . ' - R$ ' . number_format($modalidade['valor'], 2, ',', '.'); ?>
					                </option>
					            <?php endforeach; ?>
					        <?php endif; ?>
					    </select>
	                ...
	                <div class="col-md-6 mb-3">
	                    <label class="fw-bold" for="complemento">Complemento <span class="text-danger">*</span></label>
	                ...
	                <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-bold">Tamanho Camiseta</label>
                            <select name="post_camiseta" class="form-select" required>
                                ...
                                <option value="Regata P">Regata P</option>
                                <option value="Regata M">Regata M</option>
                                <option value="Regata G">Regata G</option>
                                <option value="Regata GG">Regata GG</option>
	                ...
	                <div class="col-md-12 mb-4">
	                	<input type="checkbox" name="post_aceite" value="Aceito os termos em: <?php echo current_time('d/m/Y H:i:s'); ?>" checked required>
		                	<?php if($id_evento) {
							    $regulamento = get_field('regulamento', $id_evento); 
							    if( $regulamento ): ?>
							    <label>Li e aceito os termos do <a class="text-primary" href="<?php echo esc_url($regulamento['url']); ?>">Regulamento</a> e os <a class="text-primary" href="#">Termos de Uso</a>.</label>
							    <?php endif; 
							} ?>
	                </div>
